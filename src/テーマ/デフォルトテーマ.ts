...
export const 配色: テーマ配色 = {
    ...
    クローム背景: '#0d1a2d',
    クローム境界線: '#1a2d4a',
    // クローム背景と同色にして既定では見えない境界線にする(未指定アプリの見た目を変えないため)。
    クローム下部境界線: '#0d1a2d',
    クロームテキスト: '#c8d0e0',
    テキスト主: '#e0e4ec',
    テキスト副: '#8892a4',
    ...
    ペインタブ境界線: '#2d2d30',
    ペインタブテキスト: '#cccccc',
    // 選択中タブの背景はパネル表面トークン(#eef0f4、ライト系)を流用しているため、
    // このテキスト色もダーク背景前提の白ではなくライト背景向けの濃色にする必要がある。
    // パネルテキスト主と同値にして、パネル表面上のテキストとしての調和を保つ。
    ペインタブアクティブテキスト: '#1a1a2e',
    // 従来 ペインタブ境界線 を非選択タブの背景に転用していた値をそのまま独立トークンへ引き継ぐ
    // (このテーマの見た目は変えない)。
    ペインタブ非アクティブ背景: '#2d2d30',
    ペインタブホバー背景: '#37373a',
    ペインタブ影: 'rgba(0, 0, 0, 0.35)',
    ペインアクセント: '#007acc',
    ペインスプリッター: '#3c3c3c',
    ペイン閉じるホバー: '#37373d',
